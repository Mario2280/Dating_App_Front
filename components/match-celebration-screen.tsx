        ...
        <div className="relative mb-12">
          <div className="relative">
            ...
            <div className="w-48 h-64 rounded-3xl overflow-hidden transform -rotate-12 shadow-xl">
              <Image src="/placeholder.svg?height=256&width=192" alt="Your photo" fill className="object-cover" />
            </div>

            {/* Right Card */}
            <div className="absolute top-8 left-16 w-48 h-64 rounded-3xl overflow-hidden transform rotate-12 shadow-xl">
              <Image src="/placeholder.svg?height=256&width=192" alt="Match photo" fill className="object-cover" />
            </div>
