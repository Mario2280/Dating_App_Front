...
export default function InstagramOAuthConnector({
  ...
  const INSTAGRAM_APP_ID = import.meta.env.NEXT_PUBLIC_INSTAGRAM_APP_ID || "your_instagram_app_id"
  const REDIRECT_URI = import.meta.env.NEXT_PUBLIC_INSTAGRAM_REDIRECT_URI || "https://your-domain.com/auth/instagram"
