    ...
    <div className={`space-y-6 ${className}`}>
      ...
      {isClient && (
        <div className="flex justify-center mb-4">
          <Suspense fallback={<div className="w-full h-12 bg-gray-100 rounded-lg animate-pulse flex items-center justify-center"><span className="text-gray-500">Loading...</span></div>}>
            <TonConnectButton />
          </Suspense>
        </div>
      )}
